...
private:
  ...
  bool handle_connection_message(connection_message message, ConnectionState* current_connection_state);
  ...
  ConnectionState* find_connection_state_by_username(std::string username, bool is_connected);
  ConnectionState* find_connection_state_by_username_connected_to(std::string username);
  void delete_connection_state_by_username(std::string username);
};
